 ...
 */
package com.zzb.sys.modular.user.service.impl;
...
import com.zzb.common.util.CommonAvatarUtil;
import com.zzb.common.util.CommonCryptogramUtil;
import com.zzb.common.util.CommonDownloadUtil;
import com.zzb.common.util.CommonEmailUtil;
import com.zzb.common.util.CommonIpAddressUtil;
import com.zzb.common.util.CommonResponseUtil;
import com.zzb.common.util.CommonServletUtil;
import com.zzb.dev.api.DevConfigApi;
import com.zzb.dev.api.DevEmailApi;
import com.zzb.dev.api.DevMessageApi;
import com.zzb.dev.api.DevSmsApi;
import com.zzb.sys.core.enums.SysBuildInEnum;
import com.zzb.sys.core.enums.SysDataTypeEnum;
import com.zzb.sys.modular.user.entity.SysUser;
import com.zzb.sys.modular.user.mapper.SysUserMapper;
import com.zzb.sys.modular.user.param.SysUserAddParam;
import com.zzb.sys.modular.user.param.SysUserEditParam;
import com.zzb.sys.modular.user.param.SysUserExportParam;
import com.zzb.sys.modular.user.param.SysUserFindPwdByEmailParam;
import com.zzb.sys.modular.user.param.SysUserFindPwdByPhoneParam;
import com.zzb.sys.modular.user.param.SysUserGetEmailValidCodeParam;
import com.zzb.sys.modular.user.param.SysUserGetPhoneValidCodeParam;
import com.zzb.sys.modular.user.param.SysUserGrantPermissionParam;
import com.zzb.sys.modular.user.param.SysUserGrantResourceParam;
import com.zzb.sys.modular.user.param.SysUserGrantRoleParam;
import com.zzb.sys.modular.user.param.SysUserIdListParam;
import com.zzb.sys.modular.user.param.SysUserIdParam;
import com.zzb.sys.modular.user.param.SysUserImportParam;
import com.zzb.sys.modular.user.param.SysUserMessageIdParam;
import com.zzb.sys.modular.user.param.SysUserMessagePageParam;
import com.zzb.sys.modular.user.param.SysUserPageParam;
import com.zzb.sys.modular.user.param.SysUserSelectorOrgListParam;
import com.zzb.sys.modular.user.param.SysUserSelectorPositionParam;
import com.zzb.sys.modular.user.param.SysUserSelectorRoleParam;
import com.zzb.sys.modular.user.param.SysUserSelectorUserParam;
import com.zzb.sys.modular.user.param.SysUserSignatureParam;
import com.zzb.sys.modular.user.param.SysUserUpdateInfoParam;
import com.zzb.sys.modular.user.param.SysUserUpdatePwdParam;
import com.zzb.sys.modular.user.param.SysUserUpdateWorkbenchParam;
import com.zzb.sys.modular.user.result.SysLoginUser;
import com.zzb.sys.modular.user.result.SysUserExportResult;
import com.zzb.sys.modular.user.result.SysUserMessageDetailResult;
import com.zzb.sys.modular.user.result.SysUserMessageResult;
import com.zzb.sys.modular.user.result.SysUserOwnPermissionResult;
import com.zzb.sys.modular.user.result.SysUserOwnResourceResult;
import com.zzb.sys.modular.user.result.SysUserPicValidCodeResult;
import com.zzb.sys.modular.user.result.SysUserPositionResult;
...
import com.zzb.auth.core.util.StpLoginUserUtil;
import com.zzb.common.cache.CommonCacheOperator;
import com.zzb.common.enums.CommonSortOrderEnum;
import com.zzb.common.excel.CommonExcelCustomMergeStrategy;
import com.zzb.common.exception.CommonException;
import com.zzb.common.listener.CommonDataChangeEventCenter;
import com.zzb.common.page.CommonPageRequest;
import com.zzb.mobile.api.MobileButtonApi;
import com.zzb.mobile.api.MobileMenuApi;
import com.zzb.sys.modular.org.entity.SysOrg;
import com.zzb.sys.modular.org.service.SysOrgService;
import com.zzb.sys.modular.position.entity.SysPosition;
import com.zzb.sys.modular.position.service.SysPositionService;
import com.zzb.sys.modular.relation.entity.SysRelation;
import com.zzb.sys.modular.relation.enums.SysRelationCategoryEnum;
import com.zzb.sys.modular.relation.service.SysRelationService;
import com.zzb.sys.modular.resource.entity.SysButton;
import com.zzb.sys.modular.resource.entity.SysMenu;
import com.zzb.sys.modular.resource.entity.SysModule;
import com.zzb.sys.modular.resource.enums.SysResourceCategoryEnum;
import com.zzb.sys.modular.resource.enums.SysResourceMenuTypeEnum;
import com.zzb.sys.modular.resource.service.SysButtonService;
import com.zzb.sys.modular.resource.service.SysMenuService;
import com.zzb.sys.modular.resource.service.SysModuleService;
import com.zzb.sys.modular.role.entity.SysRole;
import com.zzb.sys.modular.role.enums.SysRoleDataScopeCategoryEnum;
import com.zzb.sys.modular.role.service.SysRoleService;
import com.zzb.sys.modular.user.enums.SysUserStatusEnum;
import com.zzb.sys.modular.user.param.*;
import com.zzb.sys.modular.user.result.*;
import com.zzb.sys.modular.user.service.SysUserService;
