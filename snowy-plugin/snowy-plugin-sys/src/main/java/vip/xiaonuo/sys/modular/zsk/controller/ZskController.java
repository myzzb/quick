...
import vip.xiaonuo.sys.modular.zsk.param.ZskEditParam;
...
public class ZskController {
    ...
    @PostMapping("/sys/zsk/zskUploadLocalReturnUrl")
    @ApiImplicitParams({
    ...
    @SaCheckPermission("/sys/zsk/page")
    @GetMapping("/sys/zsk/page")
    ...
    @CommonLog("添加知识库管理")
    @SaCheckPermission("/sys/zsk/add")
    @PostMapping("/sys/zsk/add")
    ...
    @CommonLog("编辑知识库管理")
    @SaCheckPermission("/sys/zsk/edit")
    @PostMapping("/sys/zsk/edit")
    ...
    @CommonLog("删除知识库管理")
    @SaCheckPermission("/sys/zsk/delete")
    @PostMapping("/sys/zsk/delete")
    ...
    @SaCheckPermission("/sys/zsk/detail")
    @GetMapping("/sys/zsk/detail")
