...
public class ZskFlController {
    ...
    @SaCheckPermission("/biz/zskfl/page")
    @GetMapping("/biz/zskfl/page")
    ...
    @CommonLog("添加知识库分类")
    @SaCheckPermission("/biz/zskfl/add")
    @PostMapping("/biz/zskfl/add")
    ...
    @CommonLog("编辑知识库分类")
    @SaCheckPermission("/biz/zskfl/edit")
    @PostMapping("/biz/zskfl/edit")
    ...
    @CommonLog("删除知识库分类")
    @SaCheckPermission("/biz/zskfl/delete")
    @PostMapping("/biz/zskfl/delete")
    ...
    @SaCheckPermission("/biz/zskfl/detail")
    @GetMapping("/biz/zskfl/detail")
    ...
    //@SaCheckPermission("/biz/zskfl/menuTreeSelector")
    @GetMapping("/biz/zskfl/menuTreeSelector")
