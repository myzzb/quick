 ...
 */
package vip.xiaonuo.sys.modular.bq.controller;
...
import vip.xiaonuo.sys.modular.bq.service.SgBqService;
...
public class SgBqController {
    ...
    @SaCheckPermission("/sys/bq/page")
    @GetMapping("/sys/bq/page")
    ...
    @CommonLog("添加标签管理")
    @SaCheckPermission("/sys/bq/add")
    @PostMapping("/sys/bq/add")
    ...
    @CommonLog("编辑标签管理")
    @SaCheckPermission("/sys/bq/edit")
    @PostMapping("/sys/bq/edit")
    ...
    @CommonLog("删除标签管理")
    @SaCheckPermission("/sys/bq/delete")
    @PostMapping("/sys/bq/delete")
    ...
    @SaCheckPermission("/sys/bq/detail")
    @GetMapping("/sys/bq/detail")
