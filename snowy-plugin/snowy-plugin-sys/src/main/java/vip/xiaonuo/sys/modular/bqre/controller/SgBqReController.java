 ...
 */
package vip.xiaonuo.sys.modular.bqre.controller;
...
import vip.xiaonuo.sys.modular.bqre.service.SgBqReService;
...
public class SgBqReController {
    ...
    @SaCheckPermission("/sys/bqre/page")
    @GetMapping("/sys/bqre/page")
    ...
    @CommonLog("添加事故标签关联")
    @SaCheckPermission("/sys/bqre/add")
    @PostMapping("/sys/bqre/add")
    ...
    @CommonLog("编辑事故标签关联")
    @SaCheckPermission("/sys/bqre/edit")
    @PostMapping("/sys/bqre/edit")
    ...
    @CommonLog("删除事故标签关联")
    @SaCheckPermission("/sys/bqre/delete")
    @PostMapping("/sys/bqre/delete")
    ...
    @SaCheckPermission("/sys/bqre/detail")
    @GetMapping("/sys/bqre/detail")
