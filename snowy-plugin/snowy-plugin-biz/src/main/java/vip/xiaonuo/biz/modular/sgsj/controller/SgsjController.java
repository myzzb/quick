 ...
 */
package vip.xiaonuo.biz.modular.sgsj.controller;
...
public class SgsjController {
     ...
     * @date  2025/02/18 15:46
     */
    @Operation(summary = "获取事故数据分页")
    @SaCheckPermission("/biz/sgsj/page")
    @GetMapping("/biz/sgsj/page")
     ...
     * @date  2025/02/18 15:46
     */
    @Operation(summary = "添加事故数据")
    @CommonLog("添加事故数据")
    @SaCheckPermission("/biz/sgsj/add")
    @PostMapping("/biz/sgsj/add")
     ...
     * @date  2025/02/18 15:46
     */
    @Operation(summary = "编辑事故数据")
    @CommonLog("编辑事故数据")
    @SaCheckPermission("/biz/sgsj/edit")
    @PostMapping("/biz/sgsj/edit")
     ...
     * @date  2025/02/18 15:46
     */
    @Operation(summary = "删除事故数据")
    @CommonLog("删除事故数据")
    @SaCheckPermission("/biz/sgsj/delete")
    @PostMapping("/biz/sgsj/delete")
     ...
     * @date  2025/02/18 15:46
     */
    @Operation(summary = "获取事故数据详情")
    @SaCheckPermission("/biz/sgsj/detail")
    @GetMapping("/biz/sgsj/detail")
