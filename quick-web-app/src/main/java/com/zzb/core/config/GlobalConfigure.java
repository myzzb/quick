...
import com.zzb.common.consts.Constants;
import com.zzb.common.prop.CommonProperties;
...
import com.zzb.common.annotation.CommonNoRepeat;
import com.zzb.common.annotation.CommonWrapper;
import com.zzb.common.cache.CommonCacheOperator;
import com.zzb.common.enums.CommonDeleteFlagEnum;
import com.zzb.common.exception.CommonException;
import com.zzb.common.listener.CommonDataChangeEventCenter;
import com.zzb.common.listener.CommonDataChangeListener;
import com.zzb.common.pojo.CommonResult;
import com.zzb.common.pojo.CommonWrapperInterface;
import com.zzb.common.util.CommonIpAddressUtil;
import com.zzb.common.util.CommonJoinPointUtil;
import com.zzb.common.util.CommonServletUtil;
import com.zzb.common.util.CommonTimeFormatUtil;
import com.zzb.core.handler.GlobalExceptionUtil;
 ...
 **/
@Configuration
@MapperScan(basePackages = {"com.zzb.**.mapper"})
public class GlobalConfigure implements WebMvcConfigurer {

    @Resource
    private CommonProperties commonProperties; // 配置文件
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        //         .addResourceLocations("file:" + commonProperties.getProfile() + "/");
        registry.addResourceHandler(Constants.RESOURCE_PREFIX + "/**")
    ...
    public static class CommonNoRepeatAop {
         ...
         */
        @Pointcut("@annotation(com.zzb.common.annotation.CommonNoRepeat)")
    ...
    public static class CommonWrapperAop {
         ...
         * @date 2022/9/15 21:27
         */
        @Pointcut("@annotation(com.zzb.common.annotation.CommonWrapper)")
